...
<LC_IDENTIFIER, denom>
<LC_OP_ASSIGNMENT_ASSIGN>
error[E2321]: malformed integer number, the only letters that may follow an integer number are 'E' -OR- 'e' for floats (i.e. 10E+15) -AND- 'B' -OR- 'b'  for binaries (i.e. 0b011)
